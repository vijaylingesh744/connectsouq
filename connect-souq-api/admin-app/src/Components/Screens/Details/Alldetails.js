...
function Alldetails() {
  ...
  const handleUpdateUserStatus = async (userId, currentStatus) => {
    ...
    const result = await Swal.fire({
      title: 'Are you sure?',
      text: 'You are about to update the user status. Proceed?',
      icon: 'warning',
    ...
    if (result.isConfirmed) {
      try {
        ...
        const res = await FetchData(`/update/user/${userId}`, 'POST', data, true, false);
        if(res.success){
          ...
          console.error("Error updating user status:", res.message);
        }
      } catch (error) {
    ...
    const fetchData = async () => {
      try {
        ...
        if (res.success) {
          ...
          setBusinessInfo(res.data.BusinessInfoData);
            ...
            <div className='d-flex flex-column card p-3' style={{ border: "0.5px solid rgb(226, 225, 225)" }}>
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <input type="text" className="form-control mb-3" id="country" value={userData?.user_type =="0"?"Buyer":userData?.user_type =="2"?"Sellet":"Business Partner"} placeholder='Enter the country' readOnly />
                </div>
                <div className="col-6">
        ...
        <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-3">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Business Partner Details</h4>
