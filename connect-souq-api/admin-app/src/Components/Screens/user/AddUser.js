    ...
    const AddBusinessInfo = async (id) => {
        try {
            ...
            if (selectedItems.length == 0) {
                toast.error(`Please Select Any Related Industries`);
                return false;
            }
                    ...
                    <div className="d-flex justify-content-start align-items-center ">
                        {!value &&
                            <label className="btn" htmlFor={`file-upload-${title}`}>
                                <img src={Upload} alt='upload' style={{ width: '30%', marginLeft: '30px' }} />
                            </label>}
                        ...
                        {value &&
                            <img src={Close} alt='close' height='10px' style={{ margin: '10%' }} onClick={() => {
                                setValue(null)
                                setView(null)
                            }} />
                        }
                        ...
                        <div className='py-4 px-3'>
                            ...
                            <ul className='d-flex flex-row flex-wrap justify-content-start' style={{ columnGap: 15 }}>
                                {selectedItems.map((item, index) => (
                                    <div className='d-flex card flex-row align-items-center my-1' style={{backgroundColor:'#8ac53f',color:'white',borderRadius:'20px'}}>
