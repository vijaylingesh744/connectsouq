...
import FilterColumn from "../CsVault/Component/FilterColumn";
          ...
          <div className=" mb-2 mt-1 px-4 bg-white rounded w-100 d-flex justify-content-between align-items-center">
            <div className="d-flex">
              {Formdata.user_type != -1 && (
                ...
                >
                  <div>
                    {Formdata.user_type == 0 ? "Buyer": Formdata.user_type == 1? "Business Parner": Formdata.user_type == 2? "Seller": "Select User"}
                  </div>
        ...
        {userList &&
          userList.map((item) => {
            ...
            return (
              ...
              <div
                key={item._id}
                className="d-flex bg-white justify-content-between my-1 px-4 py-2 d-none"
                style={card}
              >
                <div className="px-3 w-50 d-flex">
                  ...
                  <div className="mx-2">
                    ...
                    <p className="text-secondary m-0" style={{ fontSize: 12 }}>
                      {item.user_type === "1"
                        ...
                        : item.user_type === "0"
                        ? "Buyer"
                        :item.user_type === "2"?"Seller":"Select User"}{" "}
                      <br />
              ...
              <img
                    ...
                    />
                    <div>
                    <div className='mb-1 d-flex justify-content-start align-items-center column-gap-2'><span className="text-dark1 fontsubtitle font-weight-bold " style={{whiteSpace:'nowrap',overflowX:'hidden',textOverflow:'ellipsis',minWidth:'30%',maxWidth:'40%'}}>{item?.first_name ? item?.first_name: "Name"}&nbsp;{item?.last_name ? item?.last_name : 'unknown'}</span><small className="fonthint w-40" style={{whiteSpace:'nowrap',overflowX:'hidden',textOverflow:'ellipsis',minWidth:'30%',maxWidth:'40%'}}>from {item?.city},&nbsp;{item?.country}</small></div>
                  ...
                  <button className="btn btn-connect " onClick={() => HandleUpdate(item._id)}>Lets' Connect</button>
              </div>
              </div>
              </>
            );
        ...
        <div className="col-9">
          ...
          {/* {state && myvalut && (
            <div className='container bg-white mt-3' style={{height:"auto"}}>
              ...
              <span className='font-weight-bold d-flex'>Status : {state?.project?.status ==1?<div><span style={{color:'#4535C1'}}>Active</span><span><img src='/images/icons/tick.png' width={20} /> </span></div> : <span style={{color:'#FF4C4C'}}>inactive</span>}
</span>
                </div>
                <div>
            ...
            <div className="container-fluid w-100">
              <div className="card p-3">
                <div className="d-flex justify-content-between">
                  <span className="fontsubtitle font-weight-bold text-connect">Business Partners</span>
                ...
                {/* <div className="container-fluid d-flex justify-content-center py-2 column-gap-3">
                        <div><span className="text-dark1 fontsubtitle">CS vault</span></div>
                        <div><span className="text-dark1 fontsubtitle">My vault</span></div>
                </div> */}
              </div>
