  ...
  return (
    <header className="topbar">
      <div className="with-vertical">
        <nav className="bp-nav-header navbar navbar-expand-lg p-0">
          <ul className="navbar-nav">
            <li className="nav-item d-block d-md-none">
              <a
                ...
                <i className="fa-bars fas text-white" />
              </a>
            </li>
            ...
            <li className="nav-item d-none d-lg-block">
              <div className='d-flex align-items-center' style={{height:"36px"}}>
                <div className="bp-search-container">
                  <span>
                    <i className='fa fa-search text-color-primary' />
                  </span>
                  <input
                    placeholder={"Search"}
                    className='text-color-primary border-0 w-100 pl-2'
                  />
                </div>
              </div>
            </li>
          ...
          <div
            className="justify-content-end w-75 pr-3"
            id="navbarNav"
          >
              ...
              <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                <li className="nav-item">
                  <a
                    ...
                    href="javascript:void(0)">
                    <i className="fa-bell fas m-1 text-white" />
                ...
                <li className="nav-item dropdown">
                  <a
                    className={`nav-link pe-0 ${Profile && "show"}`}
                    href="javascript:void(0)"
                    id="drop1"
                  ...
                  <div
                    className={`dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up ${Profile && "show"}`}
                      ...
                      <div className="message-body">
                        ...
                        >
                          <span className="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                            <img
                              src="/bp-assets/images/svgs/icon-account.svg"
                              alt=""
                              width={24}
                              height={24}
                            />
                        ...
                        >
                          <span className="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                            <img
                              src="/bp-assets/images/svgs/icon-inbox.svg"
                              alt=""
                              width={24}
                              height={24}
                            />
                        ...
                        >
                          <span className="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                            <img
                              src="/bp-assets/images/svgs/icon-tasks.svg"
                              alt=""
                              width={24}
                              height={24}
                            />
        ...
        >
          <nav className="sidebar-nav scroll-sidebar">
            <div className="offcanvas-header justify-content-between">
              <img
                src="/bp-assets/images/logos/favicon.ico"
                alt=""
                className="img-fluid"
              />
              <button
                  ...
                  <ul aria-expanded="false" className="collapse first-level my-3">
                    <li className="sidebar-item py-2">
                      <a href="#" className="d-flex align-items-center">
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-chat.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-invoice.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-mobile.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-message-box.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-cart.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-date.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-lifebuoy.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
                    ...
                    <li className="sidebar-item py-2">
                      ...
                      >
                        <div className="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                          <img
                            src="/bp-assets/images/svgs/icon-dd-application.svg"
                            alt=""
                            className="img-fluid"
                            width={24}
                            height={24}
      ...
      <div className="app-header with-horizontal">
        <nav className="navbar navbar-expand-xl container-fluid p-0">
          ...
          <div className="d-block d-xl-none">
            <a href="index" className="text-nowrap nav-link">
              <img src="/bp-assets/images/logos/C_logo.png" width={180} alt="" />
            </a>
          </div>
          <a
            className="navbar-toggler nav-icon-hover p-0 border-0"
            ...
            <div className="d-flex align-items-center justify-content-between px-0 px-xl-8">
              ...
              <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <img
                      src="/bp-assets/images/svgs/icon-flag-en.svg"
                      alt=""
                      width="20px"
                      height="20px"
                  ...
                  >
                    <div className="message-body">
                      ...
                      >
                        <div className="position-relative">
                          <img
                            src="/bp-assets/images/svgs/icon-flag-cn.svg"
                            alt=""
                            width="20px"
                            height="20px"
                            className="rounded-circle object-fit-cover round-20"
                      ...
                      >
                        <div className="position-relative">
                          <img
                            src="/bp-assets/images/svgs/icon-flag-fr.svg"
                            alt=""
                            width="20px"
                            height="20px"
                            className="rounded-circle object-fit-cover round-20"
                      ...
                      >
                        <div className="position-relative">
                          <img
                            src="/bp-assets/images/svgs/icon-flag-sa.svg"
                            alt=""
                            width="20px"
                            height="20px"
                            className="rounded-circle object-fit-cover round-20"
                  ...
                  >
                    ...
                    <div className="message-body" data-simplebar="">
                      ...
                      >
                        <span className="me-3">
                          <img
                            src="/bp-assets/images/profile/user-2.jpg"
                            alt="user"
                            className="rounded-circle"
                            width={48}
                            height={48}
                      ...
                      >
                        <span className="me-3">
                          <img
                            src="/bp-assets/images/profile/user-3.jpg"
                            alt="user"
                            className="rounded-circle"
                            width={48}
                            height={48}
                      ...
                      >
                        <span className="me-3">
                          <img
                            src="/bp-assets/images/profile/user-4.jpg"
                            alt="user"
                            className="rounded-circle"
                            width={48}
                            height={48}
                      ...
                      >
                        <span className="me-3">
                          <img
                            src="/bp-assets/images/profile/user-5.jpg"
                            alt="user"
                            className="rounded-circle"
                            width={48}
                            height={48}
                          ...
                          <div className="row">
                            ...
                            <div className="col-6">
                              <div className="m-n4 unlimited-img">
                                <img
                                  src="/bp-assets/images/backgrounds/unlimited-bg.png"
                                  alt=""
                                  className="w-100"
                                />
                              </div>
