          ...
          >
            <div className="w-100 h-100">
              <div className="p-lg-4 mt-4 mt-lg-0">
                ...
                <h3 className="fonttitle" style={{ marginTop: "20px" }}>Personal Skills</h3>
                ...
                <div className="row">
                  ...
                  <div className="px-3">
                    <div className="pb-2 fontsubtitle"> Let us know your Industry:</div>
                    <ul
                      className="d-flex flex-row flex-wrap justify-content-start"
                      style={{ columnGap: 15, rowGap: 10 }}
                    >
                      {SelectedIndustry.map((item, index) => (
                        <div style={{ background: '#4535C1', color: '#fff', borderRadius: 25 }} className="d-flex card mb-0 flex-row align-items-center">
                          <li
                            key={index}
                            className=" px-2 py-1"
                      ...
                      >
                        {options.map((item, index) => ({ title: item.title, id: item._id }))
                          ...
                          .map(({ title, id }) => (
                            ...
                            >
                              <label
                                className='d-flex fontcontent2 justify-content-around px-2 py-1'
                  ...
                  <div className={`${SelectedIndustry.length>0?"d-block":"d-none"}`}>
                  <div className="px-3">
                    <div className="pb-2 fontsubtitle"> Let us know your interests:</div>
                    <ul
                      className="d-flex flex-row flex-wrap justify-content-start"
                      style={{ columnGap: 15, rowGap: 10 }}
                    >
