              ...
              <button className="btn btn-warning " onClick={undoClick}>
                ...
                <button
                  ...
                  onClick={Imagecropper}
                    // Convert the crop from percentage to pixel values
                >Crop Image
                </button >
...
>
  x
      ...
      <div className="d-flex flex-column text-center d-flex justify-content-center" >
  <div className="">
      <div className="modal-content card"
      style={{
        height:"420px",
...
<a className="btn btn-danger text-light fontsubtitle" onClick={()=>CloseModal()}>
Cancel            
</a>
<button className="btn btn-connect1 fontsubtitle" onClick={Imagecropper}>
Apply            
</button>
