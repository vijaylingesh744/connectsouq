...
const Profile = () => {
    ...
    const InputField = (label, name, type, value, onChange, placeholder, caplatize) => (
        <div className={` outlined-input ${name == 'designation' ? 'col-lg-12' : 'col-lg-6'} col-12 mb-2 mt-3 inputs-form`}>
            <input
                type={type}
                className="fontcontent1 w-100 rounded-01 border-1"
                name={name}
                value={value}
                style={{ color: 'black' }}
                onChange={(e) => {
    ...
    const SelectOption = (title, col = 3, name, type, value, onChange) => {
        ...
        return (
            <div className="col-lg-6 col-12 mb-2 mt-3 outlined-input inputs-form">
                <select
                    name={name}
                    value={con ? (defaultValue || value) : value}
                    className='form-control rounded-01 border-1 fontcontent1'
                    onChange={onChange}
    ...
    return (
        <div>
            <div>
                ...
                {/* <div className='container-fluid px-lg-5 px-2 w-100 mt-3' style={{ height: '100px' }}> */}
                <div className='feed_doublecontainer' style={{ display: 'grid' }}>
                <section id="ads"></section>
                <div id="main-wrapper " className='mb-2 mt-5 mt-lg-0 pr-lg-3'>
                ...
                <div className='d-block d-md-none d-lg-none'>
                            ...
                            {stage == 0 ? (
                                <div className='container-fluid rounded d-flex justify-content-center bg-white shadow-sm  px-0'>
                                    <div className='card shadow-none w-100  px-lg-5 py-3 mb-5'>
                                        ...
                                        {InputField("Phone", "phone", "number", personalformdata.phone, handleInputChangepersonal, "Enter your Phone", false)}
                                        {/* {Input("Phone", 6, "user_type", "text", personalformdata.user_type, handleInputChangepersonal, true)} */}
                                        </div>
                                        <div className="row px-3">
                                        ...
                                        <div className="col-lg-6 col-12 mb-2 mt-3 outlined-input inputs-form">
                                            <input list="citys" name="city"
                                                ...
                                                className="form-control inputcontrol rounded-01 border-1  fontcontent1"
                                                style={{ color: 'black', border: '1px solid #767676' }}
                                        ...
                                        <div className='outlined-input col-12'>
                                            <textarea
                                                ...
                                                className='pt-3 w-100 mt-3 mb-2'
                                            />
                                ...
                                <div>
                                    {step == 0 ? (
                                        <>
                                            <div className='container-fluid px-0 bg-white rounded shadow-sm' style={{ minHeight: '45vh' }}>
                                                <div className="card w-70 shadow-none justify-content-center pt-5 row-gap-4 align-items-center" style={{ margin: 'auto' }}>
                                                    <div className="text-center px-3"><span className='fontsubtitle font-weight-bold text-center text-dark1'>To Add/Update your Business or company info you need to visit our</span></div>
                                                    <div className="w-100 px-3 d-flex justify-content-center"><button className='btn btn-connect px-3 py-1 fontsubtitle'
                                                        onClick={() => {
                                                            if (!localStorage.getItem('TRANSACTIONLOGIN')) {
                                                                localStorage.setItem("VERIFYDATA", JSON.stringify(user.user))
                                                                window.location.href = "/bp/login"
                                                            } else {
                                                                window.location.href = "/bp/dashboard"
                                                            }
                                                        }}
                                                    >Transaction Module</button></div>
                                                    <div className="px-3 text-center"><span className="fontcontent1 text-secondary1 "><strong className="text-dark1">Note : </strong>Transaction module is for completing the transactions without risking security.</span></div>
                                                </div>
                                            </div>
                                        </>
                                    ) : (
                    ...
                    <div className='d-none d-md-block d-lg-block'>
                            <div className='card shadow-sm px-3 py-3 w-100 bg-white ' style={{ minHeight: 'auto', position: 'sticky', top: '70px' }}>
                                <span className='text-dark1 fontsubtitle font-weight-bold d-none d-md-block d-lg-block'>Profile details</span>
                                <p className='text-secondary1 fontcontent2 w-100 d-none d-md-block d-lg-block'>This Details will be shown in your profile page to all as Public.</p>
                                <div className='py-3' style={{ borderBottom: '1px solid lightgrey', cursor: 'pointer' }} onClick={() => setstage(0)}>
                                    <span className='fontcontent1 font-weight-normal' style={{ color: stage == 0 ? '#4535C1' : '#6c757d' }}>Profile</span>
                                </div>
                                <div className='py-3' style={{ borderBottom: '1px solid lightgrey', cursor: 'pointer' }} onClick={() => setstage(1)}>
